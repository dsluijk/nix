...
in {
  ...
  config = mkIf cfg.enable {
    ...
    users.users.${config.modules.user.username}.extraGroups = mkMerge [
      (mkIf cfg.networkmanager ["networkmanager"])
    ];
    ...
    networking.wireless = {
      ...
      # https://mynixos.com/options/networking.networkmanager.ensureProfiles
      # networks =
      #   {
